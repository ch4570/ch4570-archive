...
포트폴리오 상세 근거는 짧은 라벨과 한 줄 근거를 묶은 밀도 높은 카드로 표시합니다. 화면에서는 데스크톱 2열, 900px 이하 1열로 전환하며, 이 컴포넌트에 한해 4px radius와 10-13px 안쪽 여백을 사용합니다. 인쇄에서는 카드 외곽 대신 2단 불릿 흐름을 유지합니다.
